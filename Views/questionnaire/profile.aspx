...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadContent" runat="server">
    <link href="/content/questionnaire/profile.css?ver=1.1.5" rel="stylesheet" type="text/css" />
    <script src="/scripts/questionnaire/profile.js?ver=1.1.5" type="text/javascript"></script>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
	<div class='wrapper'>
		<div class='ui-header'>
			<div class='ui-blank'></div>
			<div class='ui-title ui-bar-c'><div class='ui-text'>ข้อมูลส่วนตัว</div><div class='ui-icon close'></div></div>
		</div>
		<div class='ui-body'>
			<div class='profile ui-hide'>
				...
				<div class='ui-line userName'><div class='ui-label'>ชื่อผู้ใช้งาน*</div><div class='ui-text ui-body-c ui-shadow ui-corner-all'><input type='text' readonly/></div></div>
				<div class='ui-line userPass'><div class='ui-label'>Password*</div><div class='ui-text ui-body-c ui-shadow ui-corner-all'><input type='password' maxlength='50'/></div></div>
				<div class='ui-line confPass'><div class='ui-label'>ยืนยัน Password*</div><div class='ui-text ui-body-c ui-shadow ui-corner-all'><input type='password' maxlength='50'/></div></div>
			</div>
		...
		<div class='ui-footer'>
			<div class='ui-line'><div class='ui-icon previous ui-hide'></div><div class='ui-icon check'></div></div>
		</div>
	</div>
