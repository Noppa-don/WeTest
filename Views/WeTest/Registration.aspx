...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div name='confirm' id="dialogConfirmOTP" class='my-popup alert ui-popup-container ui-popup-hidden'>
        <div class='ui-content ui-body-c ui-corner-all ui-shadow'>
            <div class='ui-icon wrong'></div>
            <div class='ui-text'></div>
            <div id="btnOKOTP" class='btn btnOK'>OK</div>
        </div>
    </div>
            ...
            <div class='ui-paragraph'>
                <div id="divPolicyEng">
                    ...
                    <ul>
                        ...
                        <li>
                            <p>
                                <strong>Application</strong> refers to WeTest , the software program provided by the Company.
                           
                            </p>
                        </li>
                        <li>
                            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to บริษัท สำนักพิมพ์วัฒนาพานิช จำกัด, 31/1-2-32/2-3 SOI SIRIPATN, MAHACHAI RD., SAMRANRASD, PRANAKORN, BANGKOK 10200.</p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>
                            <p>By email: misse@wpp.co.th</p>
                        </li>
                        <li>
                            <p>
                                By visiting this page on our website: http://www.wpp.co.th
