...
function defaultLoad(){
	getQuiz();
	$('.content.main .lv1 .ui-block.q1').removeClass('ui-hide').addClass('ui-show');
...
function getQuiz(){
	$('.content.main .lv1').empty()
	for(var i=0;i<5;i++){
		$('.content.main .lv1').append("<div class='ui-block q"+($('.content.main .lv1 .ui-block').length+1)+" ui-hide'><div class='question'>ข้อ "+($('.content.main .lv1 .ui-block').length+1)+"</div><div class='answer'></div></div>");
	}
}
